...
from .sm_check import QuickOsintSmCheckStrategy, UniversalSearchSmCheckStrategy, InfoBazaSmCheckStrategy
...
class BotBuilder:
    ...
    _SM_MAP: BotMapType = [
        ...
        (UniversalSearchBot, UniversalSearchSmCheckStrategy),
        (InfoBazaBot, InfoBazaSmCheckStrategy)
    ]
