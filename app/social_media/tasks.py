...
from .webdriver.management import collect_groups, collect_unknown_profiles, collect_profiles, discover_profiles
...
def discover_profiles(self: Task, suspect_place: int):
    discover_profiles(suspect_place, self.request.id)
